...
arousal_layout = html.Div(children=[
    ...
    html.Div([
        dcc.Link('Valencia', href='http://127.0.0.1:8050/principal/valence/', className="option-button option-button-derecha option-button-inactive"),
        dcc.Link('Arousal', href='http://127.0.0.1:8050/principal/arousal/', className="option-button option-button-izquierda option-button-active"),
